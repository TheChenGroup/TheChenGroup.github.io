...
<div class="red-theme">
  ...
  <ResearchCard image="research/2024-spin-penalty.avif">
    ...
    Optimiztions in deep learning QMC methods are not guaranteed to produce quantum states with the desired spin symmetry. We introduce a low-scaling penalty term that enforces spin symmetry with minimal computational overhead, achieving higher accuracy and efficiency for excited-state calculations.
